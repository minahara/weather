...
$.simpleWeather({
    ...
    error: function(error) {
      ...
      console.log('Oops! Something went wrong...Spokane weather changes every 5 minutes anyway.');
    }
...
$.simpleWeather({
    ...
    success: function(weather) {
      ...
      // Display Data
      $('#long .temp').text(weather.temp);
      $('#long .city').text(weather.city);
      $('#long i').addClass('icon-'+ weather.code);
